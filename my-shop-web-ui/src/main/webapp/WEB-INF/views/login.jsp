...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/assets/css/ziy.css">
        ...
        <div class="login_form">
            <div class="login_tab">
                ...
                <div class="dengl_erwm">
                    <a href="#"><img src="/assets/images/er_wm.png"></a>
                    <div class="tanc_erwm_kuang">
                        <img src="/assets/images/mb_wangid.png">
            ...
            <div class="kengl_kuang">
                ...
                <form action="/login" method="post">
                    <div class="txt_kuang">
                        <input type="text" name="username" id="username" class="itxt"  placeholder="邮箱/用户名/已验证手机">
                        <input type="password" name="password" id="password" class="itxt"  placeholder="密码">
                        <input type="test" name="verification" id="verification" class="itxt"  placeholder="验证码" style="width: 119px">
