...
<div class="beij_center">
    <div class="ger_zhuc_beij">
        <div class="ger_zhuc_biaot">
            <ul>
                <li class="ger_border_color"><a href="./zhuc.jsp">个人注册</a></li>
                <i>丨</i>
                <li><a href="shenq_ruz.html">申请入驻</a></li>
                <p>我已经注册，现在就<a class="ftx-05 ml10" href="/loginPage">登录</a></p>
            </ul>
        </div>
            ...
            <div class="zhuc_biaod">
                ...
                <div class="reg-items" >
              	<span class="reg-label">
                    ...
                    <input type="submit" class="reg-btn" value="立即注册" type="button">
                </div>
            </div>
        </form>
        <div class="xiaogg">
            <img src="/assets/images/cdsgfd.jpg">
        </div>
    </div>
</div>
