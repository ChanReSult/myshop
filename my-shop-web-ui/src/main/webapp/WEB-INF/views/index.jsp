...
<head>
    ...
    <script type="text/javascript" src="/assets/js/jquery.SuperSlide.2.1.1.source.js"></script>
</head>
<body>
<!--侧边-->
        ...
        <ul class="header-right">
            <li class="denglu">
                ...
                <c:if test="${tbUser != null}">
                    <a>${tbUser.username} 欢迎回来！</a>
                </c:if>
                <c:if test="${tbUser == null}">
                    <a class="red" href="/loginPage">请登录!</a>
                </c:if>
                <a href="/logout">[注销]</a>
            ...
            <li class="shouji bj">
                ...
                <div class="shouji1">
                    <img src="/assets/images/mb_wangid.png" class="shouji4">
                    <div class="shouji2">
                        <p>MyShop客户端</p>
...
<div class="toub_beij">
    ...
    <div class="right">
        ...
        <div class="dorpdown-layer">
            <ul>
                <li class="meiyou">
                    <img src="/assets/images/settleup-nogoods.png">
            ...
            <div class="font-item">
                ...
                <div class="font-item1">
                    ...
                    <div class="font-right">
                        <div>
                            <a href="#">
                                <img src="/assets/images/562f4971Na5379aba.jpg">
                            </a>
                            <a href="#">
                                <img src="/assets/images/54d9eef9N5bb8d27f.jpg">
                            </a>
                            <a href="#">
                                <img src="/assets/images/54d9ef02N99d26435.jpg">
                            </a>
                            <a href="#">
                                <img src="/assets/images/54d9ef10Nd206a236.jpg">
                            </a>
                            <a href="#">
                                <img src="/assets/images/54d9ef28N00328d44.jpg">
                            </a>
                            <a href="#">
                                <img src="/assets/images/54d9ef34N7cc61f4c.jpg">
                            </a>
                            <a href="#">
                                <img src="/assets/images/54d9ef3eN99aef1f0.jpg">
                            </a>
                            <a href="#">
                                <img src="/assets/images/54d9ef4cN4fe57f9b.jpg">
                            </a>
                        </div>
                    </div>
                    <div class="font-righty">
                        <a href="#">
                            <img src="/assets/images/5673a854N10856704.jpg">
                        </a>
                        <a href="#">
                            <img src="/assets/images/56a0376aN7de1bdcf.jpg">
                        </a>
                    </div>
                </div>
            </div>
...
<div id="lunbo">
    <ul id="one">
        <c:forEach items="${ppt}" var="ppt">
            <li><a href="${ppt.url}"><img src="${ppt.pic}" alt="${ppt.pic}" title="${ppt.pic}"></a></li>
        </c:forEach>
    </ul>
...
<div class="bend_beij">
    ...
    <div class="bend_dhengh">
        ...
        <div class="jiank_meis">
            <div class="kuang_1">
                <a href="#">
                    <img src="/assets/images/jiank_meis.jpg">
            ...
            <div class="lunb_t">
                <div class="picScroll_left_1">
                    <div class="bd">
                        <ul class="picList">
                            <li>
                                <div class="pic"><a href="#" target="_blank"><img src="/assets/images/lengy.jpg" /></a></div>
        ...
        <div class="toum_">
            <ul>
                <li><a href="#"><img src="/assets/images/jiudi_kez.jpg">
                    <div class="jiank_meis_wenz_1">
                        <p>健康美食</p>
                    </div>
                </a>
                </li>
                <li class="sdfs"><a href="#"><img src="/assets/images/xiux_yvl.jpg">
                    <div class="jiank_meis_wenz_1">
                        <p>休闲娱乐</p>
                    </div>
                </a>
                </li>
                <li><a href="#"><img src="/assets/images/liren.jpg">
                    <div class="jiank_meis_wenz_1">
                        <p>丽人</p>
                    </div>
                </a>
    ...
    <div class="zhoub">
        ...
        <div class="zhoub_neir">
            <ul>
                <li><a href="#"><img src="/assets/images/zoub.jpg"></a></li>
                <li><a href="#"><img src="/assets/images/zoub2.jpg"></a></li>
                <li><a href="#"><img src="/assets/images/zoub3.jpg"></a></li>
            </ul>
        </div>
    </div>
        ...
        <li>
            <div class="list-li-box">
                <a class="list-img" href="#" data-code="index01004-1" target="_blank">
                    <img src="/assets/images/meinv_1.jpg">
        ...
        <li>
            <div class="list-li-box">
                <a class="list-img" href="#" data-code="index01004-2" target="_blank">
                    <img src="/assets/images/meinv_2.jpg">
                    <span class="list-bg"></span>
                    <div class="list-cont">
        ...
        <li>
            <div class="list-li-box">
                <a class="list-img" href="#" data-code="index01004-3" target="_blank">
                    <img src="/assets/images/meinv_3.jpg">
                    <span class="list-bg"></span>
                    <div class="list-cont">
        ...
        <li>
            <div class="list-li-box">
                <a class="list-img" href="#" data-code="index01004-4" target="_blank">
                    <img src="/assets/images/meinv_4.jpg">
                    <span class="list-bg"></span>
                    <div class="list-cont">
        ...
        <div class="zhongj_youx">
            ...
            <div class="lieb_daoh lieb_daoh_you">
                <div class="erw_ma_beij">
                    <div class="erw_m">
                        <h1><img src="/assets/images/mb_wangid.png"></h1>
