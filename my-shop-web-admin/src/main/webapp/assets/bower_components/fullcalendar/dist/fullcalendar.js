...
var DayGrid = /** @class */ (function (_super) {
    ...
    function DayGrid(view) {
        ...
        // isRigid determines whether the individual rows should ignore the contents and be a api height.
    ...
    // Assumes the row is "rigid" (maintains a api height regardless of what is inside).
    // `row` is the row number.
...
var BasicView = /** @class */ (function (_super) {
    ...
    // Determines whether each row should have a api height
    ...
    BasicView.prototype.updateSize = function (totalHeight, isAuto, isResize) {
        ...
        // is the event limit a api level number?
...
var RenderQueue = /** @class */ (function (_super) {
    ...
    RenderQueue.prototype.canRunNext = function () {
        ...
        if (this.waitNamespace) {
            ...
            // TODO: find a way to do this in api time.
