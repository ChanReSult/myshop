                        ...
                        <form:form cssClass="form-horizontal" action="/user/save" method="post" modelAttribute="tbUser">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input path="password" type="password" cssClass="form-control"  name="password" placeholder="请输入登录密码"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <form:input path="phone" type="text" class="form-control" placeholder="请输入用户的手机号"/>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
